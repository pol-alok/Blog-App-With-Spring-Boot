                ...
                <form:form action="../update-post" modelAttribute="singlePost">
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <form:input type="text" class="form-control" id="inputSubject" path="title"/>
                            <!--required remaining-->
                        </div>
                        <div class="form-group">
                            <label for="inputMessage">Content</label>
                            <form:textarea  class="form-control" id="inputMessage" rows="10" path="content"/><!--required remaining-->
                        </div>
